...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?= baseUrl('dist/plugins/fontawesome-free/css/all.min.css')?>">
    <!-- icheck bootstrap -->
    <link rel="stylesheet"
        href="<?= baseUrl('dist/plugins/icheck-bootstrap/icheck-bootstrap.min.css')?>">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= baseUrl('dist/css/adminlte.min.css')?>">
    <!-- Logo -->
    <link rel="icon" type="image/png" href="<?= baseUrl('dist/img/logo.png')?>">
    <!-- Pace Style-->
...
<body class="hold-transition login-page bg-primary">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center bg-dark">
                <img src="<?= baseUrl('dist/img/logo.png')?>" width="100px">
            </div>
            ...
            <div class="card card-footer bg-info">
                <div class="text-left">
                    <p class="mb-0">
                        <a href="#" id="registro" class="text-center text-white">Registrate</a>
                    </p>
                    <p class="mb-0">
    ...
    <?php echo view('login/registro')?>

    <!-- jQuery -->
    <script src="<?= baseUrl('dist/plugins/jquery/jquery.min.js')?>"></script>
    <!-- Bootstrap 4 -->
    <script src="<?= baseUrl('dist/plugins/bootstrap/js/bootstrap.bundle.min.js')?>"></script>
    <!-- AdminLTE App -->
    ...
    <!-- Base -->
    <script src="<?= baseUrl('dist/js/base.js')?>"></script>
    <!-- Pace -->
    <script src="<?= baseUrl('dist/plugins/pace-progress/pace.min.js')?>"></script>

    <script type="text/javascript">
    var base = "http://localhost/facturacion/facturacion_servidor/";
